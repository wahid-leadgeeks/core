  ...
  return (
    <header className="h-16 sticky top-0 z-30 border-b border-slate-800/80 bg-[#0a0f1d]/85 backdrop-blur-md px-4 sm:px-6 md:px-8 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="lg:hidden text-xs font-mono font-semibold text-slate-200">
          {getDomainLabel()}
        </span>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={logout}
          className="p-2 rounded-lg text-slate-400 hover:text-rose-400 hover:bg-slate-900/80 transition-colors ml-1"
