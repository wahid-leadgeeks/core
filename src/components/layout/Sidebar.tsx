              ...
              {NAV_ITEMS.map((item) => {
                ...
                if (restricted) {
                  return (
                    <li key={item.href}>
                      <div
                        className="flex items-center justify-between px-3 py-2 rounded-lg text-sm text-slate-400/60 cursor-not-allowed select-none bg-slate-900/40 border border-slate-800/50"
