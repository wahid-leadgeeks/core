...
import { Laptop, X, Shield, Cpu, HardDrive, Key, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl max-w-xl w-full p-6 shadow-2xl my-8">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-slate-100">Provision Hardware Asset</h2>
              <p className="text-xs text-slate-400">Onboard a new laptop into active infrastructure inventory</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 font-mono"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                required
                className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
              />
            </div>

            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Computer / Hostname</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div>
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded px-2.5 py-1.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                />
              </div>
              <div>
                <input
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              <div>
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded px-2.5 py-1.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 font-mono"
                />
              </div>
            </div>
          </div>
          ...
          <div>
            <label className="block text-xs font-medium text-slate-300 mb-1">Administrative Notes</label>
            <textarea
              rows={2}
              placeholder="e.g. Purchased with 3-year warranty from official distributor."
              value={notes}
              onChange={(e) => setNotes(e.target.value)}
              className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
          </div>
